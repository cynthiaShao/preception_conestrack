...
cv2.drawContours(img_edges, [c], -1, (0, 255, 0), 2)
cv2.circle(img_edges, (cX, cY), 7, (255, 255, 255), -1)
cv2.putText(img_edges, "center", (cX - 20, cY - 20),
cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
# show the image with cones' center
cv2.imshow("Image of cone centers", img_edges)
cv2.waitKey(0)
centers.append((cX, cY))
centers = sorted(centers, key=lambda tup: tup[0])
cts = np.int32(centers)
#connect the center of each cones
cv2.polylines(img, [cts], True, (255, 0, 0), 2, cv2.LINE_AA)  
